...
p1 = ggplot(arms2, aes(x = size, y = clpp, label = eqtl_file)) + geom_point() + geom_text(hjust = 0,angle = 90)
...
p2 = ggplot(plekha1, aes(x = size, y = clpp, label = eqtl_file)) + geom_point() + geom_text(hjust = 0,angle = 90)
